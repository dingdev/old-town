...
@ApiModel(value="TrfYacht对象", description="交通接驳游船")
public class TrfYacht implements Serializable {
    ...
    @ApiModelProperty(value = "#游船员工姓名" , hidden = true)
    @TableField(exist = false)
    private String staffName;

    @ApiModelProperty(value = "#游船员工编号" , hidden = true)
    @TableField(exist = false)
    private String staffSerial;

    @ApiModelProperty(value = "#游船员工电话" , hidden = true)
    @TableField(exist = false)
