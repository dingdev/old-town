 ...
 * @since 2020-11-25
 */
public interface TrfSweepStaffService extends IService<TrfSweepStaff> {
    ...
    */
     ...
     * 根据id查询交通接驳打捞船员工
     */
    CommonResult getSweepStaffById(Long id);

    /**
     * 增加交通接驳打捞船员工
     */
    CommonResult add(TrfSweepStaff trfSweepStaff);

    /**
     * 更新交通接驳打捞船员工
     */
    CommonResult update(TrfSweepStaff trfSweepStaff);
    /**
     * 删除交通接驳打捞船员工
     */
