...
@ApiModel(value="TrfSweep对象", description="交通接驳打捞船")
public class TrfSweep implements Serializable {
    ...
    @ApiModelProperty(value = "#打捞船员工姓名" , hidden = true)
    @TableField(exist = false)
    private String staffName;

    @ApiModelProperty(value = "#打捞船员工编号" , hidden = true)
    @TableField(exist = false)
    private String staffSerial;

    @ApiModelProperty(value = "#打捞船员工电话" , hidden = true)
    @TableField(exist = false)
